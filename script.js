const projectsArray = [
  ...
  {
    name: "Weather App",
    description: "Checks weather for a specific country/city.",
    imageUrl: "Images/Weather-app.png",
  },
  {
    name: "Book Nest",
    description: "Your personal books manager.",
    imageUrl: "Images/book-nest.png",
  },
  {
    name: "Tic-Tac-Toe",
    description: "A simple two/one player tic-tac-toe game",
    imageUrl: "Images/tic-tac-toe.png",
  },
  {
    name: "Calculator",
    description: "Your personal casio style calculator",
    imageUrl: "Images/calculator.png",
  },
  {
    name: "Odin Sinup Page",
    description: "Sign up page for an asgard government greivance portal.",
    imageUrl: "Images/singup.png",
  },
];
...
projectsArray.forEach((project) => {
  ...
  <a href="https://github.com/Shubham277353" target="_blank">
  ...
  <span class="icon live-preview">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                          <title>live preview (opens in new tab)</title>
                          <path d="M4,6H20V16H4M20,18A2,2 0 0,0 22,16V6C22,4.89 21.1,4 20,4H4C2.89,4 2,4.89 2,6V16A2,2 0 0,0 4,18H0V20H24V18H20Z"></path></svg></span></a>
  `;
